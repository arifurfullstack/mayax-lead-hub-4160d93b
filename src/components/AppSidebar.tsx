            ...
            <SidebarGroupContent>
              <SidebarMenu>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton
                    asChild
                    isActive={isActive("/admin/webhook-tester")}
                    tooltip="Webhook Tester"
                  >
                    <NavLink
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton
                    asChild
                    isActive={isActive("/admin/webhook-templates")}
                    tooltip="Webhook Templates"
                  >
                    <NavLink
                      to="/admin/webhook-templates"
                      end
                      className="flex items-center gap-3 px-3 py-2 rounded-md text-sm text-muted-foreground hover:text-foreground hover:bg-sidebar-accent transition-colors"
                      activeClassName="bg-sidebar-accent text-gold font-medium"
                    >
                      <BookOpen className="h-4 w-4 shrink-0" />
                      {!collapsed && <span>Webhook Templates</span>}
                    </NavLink>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem>
