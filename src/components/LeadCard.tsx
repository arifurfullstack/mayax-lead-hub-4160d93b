        ...
        {isAdminView && (
          <Tooltip>
            <TooltipTrigger asChild>
              <span className={cn(
                "text-[10px] font-bold px-1.5 py-0.5 rounded border border-primary/40 bg-primary/15 text-primary uppercase tracking-wider font-mono-timer flex items-center gap-1 cursor-help",
                !(lead.quality_grade && promoPrice == null) && "ml-auto"
              )}>
